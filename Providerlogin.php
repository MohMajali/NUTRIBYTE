...
if (isset($_POST['Submit'])) {
    ...
    $query = mysqli_query($dbConn, "SELECT * FROM providers WHERE email ='$Email' AND password = '$Password' AND active = 1");
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        document.location="Provider_Dashboard/";
        </script>';
...
<html lang="en">
  <head>
    ...
    <title>NUTRIBYTE | Meal Provider Login</title>
  </head>
  <body>
    ...
    <div class="container white z-depth-2">
      ...
      <div id="login" class="col s12">
        <form class="col s12" action="Providerlogin.php" method="POST">
