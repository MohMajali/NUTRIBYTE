  ...
  <body>
    ...
    <div class="class">
      <div class="container">
        ...
        <?php
$sql1 = mysqli_query($dbConn, "SELECT * FROM orders WHERE user_id ='$U_ID' ORDER BY id DESC");
    ...
    while ($row1 = mysqli_fetch_array($sql1)) {
        ...
        $sql2 = mysqli_query($dbConn, "select * from users where id='$provider_id'");
        ...
        <div class="row class-container">
          <div
            class="col-12 class-item-order class-item wow fadeInUp"
            data-wow-delay="0.0s">
            <div class="class-wrap">
              <div class="class-img">
                <img
                  src="../Nutrionist_Dashboard/<?php echo $m_image?>"
                  alt="Image"
                />
              </div>
              <div class="class-text">
                <div>
                  <h2><a class="anchor" href="#"><?php echo $m_name?></a></h2>

                  <div class="class-meta">
                    <!-- <p><i class="fas fa-map-marker-alt"></i>Amman - Khalda</p> -->
                  <p><i class="far fa-money-bill"></i>Status : <?php echo $s_name?></p> 
                  <p><i class="far fa-money-bill"></i><?php echo $m_price?> JOD</p> 
                  </div>

                </div>
                <!-- <div class="class-text-btns">
