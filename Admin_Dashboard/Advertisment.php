...
if (!$A_ID) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        $insert = mysqli_query($dbConn, "INSERT INTO advertisements (title, description, image)

        Values ('$title','$desc','$file')");
//============================================================================================================
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        <div class="page-title d-flex flex-column w-100 align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                               <div>
                                <h1 class="text-dark fw-bolder my-0 fs-1">Advertisments</h1>
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer align-items-center" role="button" data-bs-toggle="" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Advertisments</h3>
            </div>
            <div style="margin-left:auto">
                <a href="#" class="btn btn-sm btn-light btn-active-primary" tooltip="Add Advertisment" data-bs-toggle="modal" data-bs-target="#AddAdvertisment">
                    ...
                    <span class="d-none d-md-inline">Add Advertisment</span>
                </a>
            </div>
            ...
            <form method="post" id="Company" enctype="multipart/form-data" >
                <div class="card-body border-top p-9">
                        <table class="table">
                            ...
                            <?php
$sql1 = mysqli_query($dbConn, "SELECT * from advertisements ORDER BY id DESC");
    ...
    while ($row1 = mysqli_fetch_array($sql1)) {
        ...
        ?>
                                <tr role="row" class="odd">
                                    <td class=""><div class=" symbol symbol-40px"><img src="./<?php echo $image ?>" /></div></td>
                                    <td class=" "><?php echo $title ?></td>
                                    <td class=" "><?php echo $description ?></td>
                                    <td class=" ">

                                    <a href="EditAdv.php?id=<?php echo $adv_id ?>" class="btn btn-primary" role="button">Edit</a>
                                    <?php if ($active == 1) {?>
                                        <a href="BlockUnBlockAdv.php?id=<?php echo $adv_id ?>" class="btn btn-danger" role="button">In-Active</a>
                                    <?php } else {?>
                                        <a href="BlockUnBlockAdv.php?id=<?php echo $adv_id ?>" class="btn btn-danger" role="button">Activate</a>
                                    <?php }?>
                                    </td>
...
<div class="notFound_card">
 <div class="notFound_card-content text-gray-400 fs-4 fw-bold mb-10 mt-10">
    ...
    <div class="modal fade" id="AddAdvertisment" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header pb-0 border-0 justify-content-center">
                    <div class="text-center mb-8 mt-2 d-flex align-items-center">
                        <h1 class="mb-3">Add Advertisment</h1>
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-4  pb-3 pt-3 modal-body-AddEmplyee">
                    ...
                    <div class="mb-10">
                        <form class="form" class="addDateTime_form" method="post" action="Advertisment.php" enctype="multipart/form-data">
                            <input type="hidden" name="OptionDateTimeCount" id="OptionDateTimeCount"  />
                            <!--begin::Card body-->
                            <div class="card-body border-top p-9">
                                <!--begin::Input group-->
                                <h3 class="mb-10">Advertisment Info</h3>
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">Advertisment Name</label>
             ...
             name="title" />
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">Advertisment Description</label>
                                    <div class="col-lg-8 fv-row">
                                        <textarea class="form-control form-control form-control-solid" data-kt-autosize="true" id="advDescription" name="desc"></textarea>
                                    </div>
                                </div>
