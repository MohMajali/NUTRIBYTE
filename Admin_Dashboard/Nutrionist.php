...
if (!$A_ID) {
    ...
    if(isset($_POST['Submit'])) {
        ...
        $rate = $_POST['rate'];
        $type = 2;
        $image = 'Nutrionist_images/defalutUser.png';

    
         $insert = mysqli_query($dbConn, "INSERT INTO users (user_type_id, name, email, password, phone, image, category_id, total_rate)
        
                Values ('$type', '$first_name', '$email', '$password', '$phone', '$image', '$category_id', '$rate')");
    
                echo "<script language='JavaScript'>
                    alert ('New Nutriontist Have Been Added Successfully !');
            </script>";
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        <div class="page-title d-flex flex-column w-100 align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                               <div>
                                <h1 class="text-dark fw-bolder my-0 fs-1">Nutrionistes</h1>
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer align-items-center" role="button" data-bs-toggle="" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Nutrionistes</h3>
            </div> 
            <div style="margin-left:auto">
                <a href="#" class="btn btn-sm btn-light btn-active-primary" tooltip="Add Teacher" data-bs-toggle="modal" data-bs-target="#AddTeacher">
                    ...
                    <span class="d-none d-md-inline">Add Nutrionist</span>
                </a>
            </div>
            ...
            <form method="post" id="Company" enctype="multipart/form-data" > 
                <div class="card-body border-top p-9"> 
                        <table class="table">
                            <thead>
                                <tr class="fw-bolder  ">
                                    <th>Nutrionist Image</th>
                                    <th>Nutrionist ID</th>
                                    <th>Nutrionist Name</th>
                                    <th>Nutrionist Email</th>
                                    <th>Nutrionist Phone</th>
                                    <th>Category Name</th>
                                    <th>Total Rate</th>
                                    <th>Actions </th>
                                </tr>
                     ...
                     <?php
$sql1 = mysqli_query($dbConn, "SELECT * FROM users WHERE user_type_id = 2 ORDER BY id DESC");
    ...
    while ($row1 = mysqli_fetch_array($sql1)) {
        ...
        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td><img src="../Nutrionist_Dashboard/<?php echo $n_image; ?>" width="110px" height="110px"/></td>
                                    <td class=" "><?php echo $n_id; ?></td>
                                    <td class=" "><?php echo $n_name; ?></td>
                                    <td class=" "><?php echo $n_email; ?></td>
                                    <td class=" "><?php echo $n_phone; ?></td>
                                    <td class=" "><?php echo $c_name; ?></td>
                                    <td>
                                        <?php for($i=1; $i<=$total_rate; $i++){
                                            echo '<img width="10" height="10" src="star.png"/>'; 
                                        }?>
                                    </td>
                                    <td class=" ">
                                        ...
                                        <?php if($active == 1) { ?>
                                            ...
                                            <a href="BlockUnBlockUser.php?id=<?php echo $n_id ?>" class="btn btn-danger" role="button">Block</a>

                                        <?php } else { ?>

                                            <a href="BlockUnBlockUser.php?id=<?php echo $n_id ?>" class="btn btn-primary" role="button">UnBlock</a>
    ...
    echo '
                      ...
                      <div class="notFound_card">
                         <div class="notFound_card-content text-gray-400 fs-4 fw-bold mb-10 mt-10">
                            There Are No Nutrionistes Added Yet.
                         </div>
                      </div>';
}?>
        ...
        <div class="modal-dialog mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-4  pb-3 pt-3 modal-body-AddEmplyee">
                    ...
                    <div class="mb-10">
                        <form class="form" class="addDateTime_form" action="Nutrionist.php" method="post" enctype="multipart/form-data">
             ...
             required/>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="number" min="0" max="5" required title="Phone Number Must Be 10 Numbers" 
                                        class="form-control form-control-lg form-control-solid" min="0" name="rate" id="phone" required />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-6">
                                <label class="col-lg-4 col-form-label fw-bold fs-6">Category Name</label>
                                <div class="col-lg-8 fv-row">
                                    <?php
$query1 = mysqli_query($dbConn, "SELECT * FROM categories");

    echo '<select name="category_id"  class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" required>';
...
?>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="password" class="form-control form-control-lg form-control-solid" name="password" value="" placeholder="" required/>
                                    </div>
                                </div>
