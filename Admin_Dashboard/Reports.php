                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        <div class="page-title d-flex flex-column w-100 align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                               <div>
                                <h1 class="text-dark fw-bolder my-0 fs-1">Reports</h1>
                ...
                <div class="card-body border-top p-9"> 
                        <table class="table">
                            <thead>
                                <tr class="fw-bolder  ">
                                    <th>Users Report</th>  
                                    <th>Providers Report</th>
                                    <th>Nutrionist Report</th>
                                    <th>Orders Report </th>
                                    <th>Promo Codes Report </th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr role="row" class="odd">
                                    <td class=" "><a href="./UsersReport.php" class="btn btn-danger" role="button">Show Report</a></td>
                                    <td class=" "><a href="./ProivdersReport.php" class="btn btn-danger"  role="button">Show Report</a></td>
                                    <td class=" "><a href="./NutrionistReport.php" class="btn btn-danger"  role="button">Show Report</a></td>
                                    <td class=" "><a href="./OrdersReport.php" class="btn btn-danger"  role="button">Show Report</a></td>
                                    <td class=" "><a href="./PromoCodesReport.php" class="btn btn-danger"  role="button">Show Report</a></td>
