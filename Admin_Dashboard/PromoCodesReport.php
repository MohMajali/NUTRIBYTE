        ...
        <div id="kt_account_profile_details" class="collapse show"> 
            <form method="post" id="Company" enctype="multipart/form-data" > 
                <div class="card-body border-top p-9"> 
                     ...
                     <?php
$sql1 = mysqli_query($dbConn, "SELECT * FROM promo_codes WHERE active = 1 ORDER BY id DESC");
...
if (mysqli_num_rows($sql1) > 0) {
    ...
    while ($row1 = mysqli_fetch_array($sql1)) {
        ...
        $sql2 = mysqli_query($dbConn, "select * from providers where id='$provider_id'");
