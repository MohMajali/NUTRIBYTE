...
if (!$A_ID) {
    ...
    $sql2 = mysqli_query($dbConn, "select * from users where id='$providerId'");
    $row2 = mysqli_fetch_array($sql2);

    $provider_name = $row2['name'];
    $id_front_image = $row2['id_front_image'];
    $id_back_image = $row2['id_back_image'];
    $statement_paper = $row2['statement_paper'];
}
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        <div class="page-title d-flex flex-column w-100 align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                               <div>
                                <h1 class="text-dark fw-bolder my-0 fs-1"><?php echo $provider_name?></h1>
                        ...
                        <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
                            ...
                            <a href="?page=index" class="d-flex align-items-center">
                                <img alt="Logo" src="../assets/img/logo.jpg" class="h-30px">
                            </a>
                        </div>
                    </div> 
                </div> 
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer align-items-center" role="button" data-bs-toggle="" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0"><?php echo $provider_name?></h3>
            </div> 
            <!-- <div style="margin-left:auto">
                <a href="#" class="btn btn-sm btn-light btn-active-primary" tooltip="Add Teacher" data-bs-toggle="modal" data-bs-target="#AddTeacher">
                    ...
                    <span class="d-none d-md-inline">Add Providers</span>
                </a>
            </div> -->
                        ...
                        <table class="table">
                            <thead>
                                <tr class="fw-bolder  ">
                                    ...
                                    <th>Back ID Image</th>
                                    <th>Statement Paper</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr role="row" class="odd">
                                    
                                    <td class=" "><?php echo $providerId; ?></td>
                                    <td class=" "><a href="<?php echo $id_front_image; ?>" class="btn btn-primary">View</a></td>
                                    <td class=" "><a href="<?php echo $id_back_image; ?>" class="btn btn-primary">View</a></td>
                                    <td class=" "><a href="../Provider_Dashboard/<?php echo $statement_paper; ?>" class="btn btn-primary">View</a></td>
                        ...
                        <form class="form" class="addDateTime_form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" pattern="[0-9]{10}" required title="Phone Number Must Be 10 Numbers" 
                                        class="form-control form-control-lg form-control-solid" name="phone" id="phone" required />
                                    </div>
                                </div>
                                <div class="row mb-6">
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">National ID</label>
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" pattern="[0-9]{10}" required title="National ID Must Be 10 Numbers" 
                                        class="form-control form-control-lg form-control-solid" name="national_id" id="phone" required />
                                    </div>
                                </div>
<!-- location_id, id_front_image, id_back_image -->

                                <div class="row mb-6">
                                <label class="col-lg-4 col-form-label fw-bold fs-6">Location</label>
                                <div class="col-lg-8 fv-row">
                                    <?php
$query1 = mysqli_query($dbConn, "SELECT * FROM locations");

    echo '<select name="location_id"  class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" required>';
    echo '<option disabled selected value>Select City Name</option>';
...
?>
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">ID Front Image</label>
                                    <div class="col-lg-8 fv-row">
                                        <input type="file" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" name="id_front_image" required/>
                                    </div> 
                                </div>

                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">ID Back Image</label>
                                    <div class="col-lg-8 fv-row">
                                        <input type="file" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" name="id_back_image" required/>
                                    </div> 
                                </div>
