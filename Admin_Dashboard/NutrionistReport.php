    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer align-items-center" role="button" data-bs-toggle="" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
            ...
            <div style="margin-left:auto">
                <a href="#" class="btn btn-sm btn-light btn-active-primary print" >
    ...
    while ($row1 = mysqli_fetch_array($sql1)) {
        ...
        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td class=" "><img src="../Nutrionist_Dashboard/<?php echo $n_image; ?>" height="150px" width="150px" alt=""></td>
                                    ...
                                    <td class=" "><?php echo $created_at; ?></td>
        ...
        <div class="modal-dialog mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-4  pb-3 pt-3 modal-body-AddEmplyee">
                    ...
                    <div class="mb-10">
                        <form class="form" class="addDateTime_form" method="post" >
                            <input type="hidden" name="OptionDateTimeCount" id="OptionDateTimeCount"  />
                            <!--begin::Card body-->
                            <div class="card-body border-top p-9">
                                <!--begin::Input group-->
                                <h3 class="mb-10">Teacher Basic Info</h3>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" name="fullname" />
                                    </div> 
                                </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" class="form-control form-control-lg form-control-solid" name="phone" id="phone" required placeholder="" />
                                    </div>
                                </div>
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">Email</label>
                                    <div class="col-lg-8 fv-row"> 
                                        <input type="email" class="form-control form-control-lg form-control-solid" name="email" id="email" required placeholder="" />
                                    </div>
                                </div>
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">Password</label>
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" class="form-control form-control-lg form-control-solid" name="password" value="" placeholder="" />
                                    </div>
                                </div>
                                <div class="row mb-6">
                                ...
                                <div class="addDateAndTime_content">
                                    <button type="button" class="addDateTime btn btn-primary angles_btn p-2 d-flex align-items-center mb-3 mt-3"><span>Add Date & Time</span><i class="bi bi-plus-circle ml-1"></i></button>
                                
                                    <div class="AddDateTime_wrapper">
                                    </div>
                                </div>
                                 

                                <div class="card-footer d-flex justify-content-end py-6 px-9">
                                    <input type="submit" class="btn btn-primary" id="regformbutt" name="regformbutt" value="Save">
                                </div>
    ...
    <script>
     ...
     <script>
        window.addEventListener('DOMContentLoaded', (event) => {
         document.querySelector('#kt_aside_nav_tab_menu .menu-item:nth-child(8) .menu-link').classList.add('active')
