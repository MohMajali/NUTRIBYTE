...
if (!$A_ID) {
    ...
    $sql2 = mysqli_query($dbConn, "select COUNT(id) AS countId from orders");
    $row2 = mysqli_fetch_array($sql2);

    $countId = $row2['countId'];
}
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer align-items-center" role="button" data-bs-toggle="" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0"><?php echo $countId?> Orders</h3>
            </div>
    ...
    while ($row1 = mysqli_fetch_array($sql1)) {
        ...
        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td class=" "><?php echo $price_after_discount ?? $m_price ?></td>
                                    <td class=" "><?php echo $s_name; ?></td>
                                    <td class=" "><?php 
                                    
                                    if($price_after_discount){

                                        echo ($price_after_discount * 10 / 100);
                                    } else if($m_price){
