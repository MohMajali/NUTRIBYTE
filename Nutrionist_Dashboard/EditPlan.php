...
if (!$N_ID) {
    ...
    $sql2 = mysqli_query($dbConn, "select * from meal_plans where id= '$f_id'");
    ...
    if (isset($_POST['Submit'])) {
        ...
        $update = mysqli_query($dbConn, "UPDATE meal_plans SET name ='$name', description = '$description' WHERE id ='$fId'");

        echo "<script language='JavaScript'>
        alert ('{$f_name} Has Been Updated Successfully !');
   </script>";
 
             echo "<script language='JavaScript'>
  document.location='ViewFoodPlan.php?nId={$N_ID}&&uId={$uId}';
     </script>";
            ...
            <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                <div class="page-title d-flex flex-column w-100 align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                    ...
                    <div class="d-flex align-items-center justify-content-between w-100">
                       <div>
                        <h1 class="text-dark fw-bolder my-0 fs-1"><?php echo $f_name?></h1>
         ...
         <div class="card mb-5 mb-xl-10">
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
               <div class="card-title m-0">
                  <h3 class="fw-bolder m-0"><?php echo $f_name?></h3>
               </div>
            </div>
            <div id="kt_account_profile_details" class="collapse show">
               <form class="form" method="post" action="EditPlan.php?id=<?php echo $f_id?>" enctype="multipart/form-data">
                ...
                <input type="hidden" name="uId" value="<?php echo $uId?>">
                  ...
                  <div class="card-body border-top p-9">
                     ...
                     <div class="row mb-6">
                        <label class="col-lg-4 col-form-label  fw-bold fs-6">Food Plan Name</label> 
                        <div class="col-lg-8">
                           <div class="row">
                              <div class="col-lg-12 fv-row">
                                 <input type="text" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"  name="name" value="<?php echo $f_name?>"/>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row mb-6">
                        <label class="col-lg-4 col-form-label  fw-bold fs-6">Food Plan Description</label> 
                        <div class="col-lg-8">
                           <div class="row">
                              <div class="col-lg-12 fv-row">
                                 <textarea name="description" 
                                 class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" id="" cols="30" rows="10"><?php echo $f_description?></textarea>
                              </div>
                           </div>
                        </div>
                     </div>
