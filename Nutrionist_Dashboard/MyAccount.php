...
if (!$N_ID) {
    ...
    if (isset($_POST['Submit'])) {
        ...
        if($password == $con_password){
         ...
         move_uploaded_file($_FILES["file"]["tmp_name"], "Nutrionist_images/" . $_FILES["file"]["name"]);
         ...
         if ($file == '' || $file == null) {
             ...
             $file = 'Nutrionist_images/' . $file;
 
             $update = mysqli_query($dbConn, "UPDATE users SET name ='$name', email ='$email', phone = '$phone', password ='$password', image='$file' WHERE id ='$ID'");
             ...
             name="username" value="<?php echo $name?>"/>
                     ...
                     <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                           ...
                           pattern="[0-9]{10}" title="Phone Number Must Be 10 Numbers" min="0"
