...
if (!$M_ID) {
    ...
    $sql2 = mysqli_query($dbConn, "select * from promo_codes where id='$C_ID'");
    ...
    if (isset($_POST['Submit'])) {
        ...
        $discount = $_POST['discount'];
            ...
            $update = mysqli_query($dbConn, "UPDATE promo_codes SET code ='$code',discount = '$discount' WHERE id ='$ID'");
            ...
            <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                <div class="page-title d-flex flex-column w-100 align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                    ...
                    <div class="d-flex align-items-center justify-content-between w-100">
                       <div>
                        <h1 class="text-dark fw-bolder my-0 fs-1">Edit <?php echo $code?></h1>
         ...
         <div class="card mb-5 mb-xl-10">
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
               <div class="card-title m-0">
                  <h3 class="fw-bolder m-0">Edit <?php echo $code?></h3>
               </div>
            </div>
            <div id="kt_account_profile_details" class="collapse show">
               <form class="form" method="post" action="EditPromocode.php?id=<?php echo $C_ID?>" enctype="multipart/form-data">
                  ...
                  <div class="card-body border-top p-9">
                        ...
                        <div class="col-lg-8">
                           <div class="row">
                              <div class="col-lg-12 fv-row">
                                 <input type="text" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"  name="code" value="<?php echo $code?>"/>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row"> 
                           <input type="number" min="0" step="0.01" class="form-control form-control-lg form-control-solid" name="discount" value="<?php echo $discount?>" required/>
                        </div>
                     </div>
