                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        <div class="page-title d-flex flex-column w-100 align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                               <div>
                                <h1 class="text-dark fw-bolder my-0 fs-1">Orders</h1>
                               </div>
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer align-items-center" role="button" data-bs-toggle="" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Orders</h3>
            </div>
        ...
        <div id="kt_account_profile_details" class="collapse show">
            <form method="post" id="Company" enctype="multipart/form-data" >
                <div class="card-body border-top p-9">
                     ...
                     <?php
$sql1 = mysqli_query($dbConn, "SELECT * FROM orders WHERE provider_id ='$M_ID' ORDER BY id DESC");
...
if (mysqli_num_rows($sql1) > 0) {
    ...
    while ($row1 = mysqli_fetch_array($sql1)) {
        ...
        if ($promo_code_id) {
            $sql5 = mysqli_query($dbConn, "select * from promo_codes where id='$promo_code_id'");
        ...
        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td class=" "><?php echo $r_id; ?></td>
                                    <td class=" "><?php echo $u_name; ?></td>
                                    <td class=" "><?php echo $u_phone; ?></td>
                                    <td class=" "><?php echo $m_name; ?></td>
                                    <td class=" "><?php echo $price; ?></td>
                                    <td class=" "><?php echo $s_name; ?></td>
                                    <td class=" ">

                                        <?php if ($status_id == 1) {?>

                                            <a href="AcceptRejectOrder.php?id=<?php echo $r_id ?>&&accept=2&&food_meal=<?php echo $m_name ?>&&promo_code_id=<?php echo $promo_code_id ?>&&meal_id=<?php echo $meal_id ?>" class="btn btn-danger" role="button">ِِAccept</a>

                                        <?php } else if ($status_id == 2) {?>

                                            <a href="StartDelivery.php?id=<?php echo $r_id ?>&&food_meal=<?php echo $m_name ?>" class="btn btn-danger" role="button">Start Delivery</a>

                                        <?php } else if ($status_id == 5) {?>

                                            <a href="Delivered.php?id=<?php echo $r_id ?>&&food_meal=<?php echo $m_name ?>" class="btn btn-danger" role="button">Delivered</a>
        ...
        <div class="modal-dialog mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-4  pb-3 pt-3 modal-body-AddEmplyee">
                    ...
                    <div class="mb-10">
                        <form class="form" class="addDateTime_form" method="post" action="Orders.php" enctype="multipart/form-data">
