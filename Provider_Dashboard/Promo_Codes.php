...
if (!$M_ID) {
    ...
    if(isset($_POST['Submit'])){
        ...
        $insert = mysqli_query($dbConn, "INSERT INTO promo_codes (provider_id, code, discount)

        Values ('$M_ID', '$code', '$discount')");
//============================================================================================================

        echo "<script language='JavaScript'>
          alert ('A New Promo Code Has Been Added Successfully !');
     </script>";
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        <div class="page-title d-flex flex-column w-100 align-items-start justify-content-center flex-wrap me-lg-2 pb-2 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
                            ...
                            <div class="d-flex align-items-center justify-content-between w-100">
                               <div>
                                <h1 class="text-dark fw-bolder my-0 fs-1">Promo Codes</h1>
                               </div>
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer align-items-center" role="button" data-bs-toggle="" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0"> Promo Codes</h3>
            </div> 
            <div style="margin-left:auto">
                <a href="#" class="btn btn-sm btn-light btn-active-primary" tooltip="Add Teacher" data-bs-toggle="modal" data-bs-target="#AddTeacher">
                    ...
                    <span class="d-none d-md-inline">Add Promo Code</span>
                </a>
            </div>
        ...
        <div id="kt_account_profile_details" class="collapse show"> 
            <form method="post" id="Company" enctype="multipart/form-data" > 
                <div class="card-body border-top p-9"> 
                     ...
                     <?php
$sql1 = mysqli_query($dbConn, "SELECT * FROM promo_codes WHERE provider_id = '$M_ID' ORDER BY id DESC");
...
if (mysqli_num_rows($sql1) > 0) {
    ...
    while ($row1 = mysqli_fetch_array($sql1)) {
        ...
        $c_id = $row1['id'];
        $c_code = $row1['code'];
        $c_discount = $row1['discount'];
        $active = $row1['active'];

        ?>
                                <tr role="row" class="odd">
                                    
                                    <td class=" "><?php echo $c_id; ?></td>
                                    <td class=" "><?php echo $c_code; ?></td>
                                    <td class=" "><?php echo $c_discount; ?></td>
                                    <td class=" ">

                                        <?php if($active == 1) { ?>

                                            <a href="BlockUnBlockCode.php?id=<?php echo $c_id ?>" class="btn btn-danger" role="button">In-Active</a>

                                        <?php } else { ?>

                                            <a href="BlockUnBlockCode.php?id=<?php echo $c_id ?>" class="btn btn-danger" role="button">Active</a>

                                        <?php } ?>
                                        
                                        <a href="EditPromocode.php?id=<?php echo $c_id ?>" class="btn btn-primary" role="button">Edit</a>
                                    </td>
    ...
    echo '
                      ...
                      <div class="notFound_card">
                         <div class="notFound_card-content text-gray-400 fs-4 fw-bold mb-10 mt-10">
                            There Are No Promo Codes Added Yet.
                         </div>
                      </div>';
}?>
            ...
            <div class="modal-content">
                <div class="modal-header pb-0 border-0 justify-content-center">
                    <div class="text-center mb-8 mt-2 d-flex align-items-center">
                        <h1 class="mb-3">Add Promo Code</h1>
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-4  pb-3 pt-3 modal-body-AddEmplyee">
                    ...
                    <div class="mb-10">
                        <form class="form" class="addDateTime_form" method="post" action="Promo_Codes.php" enctype="multipart/form-data">
                            <input type="hidden" name="M_ID" value="<?php echo $M_ID ?>"/>
                            <!--begin::Card body-->
                            <div class="card-body border-top p-9">
                                <!--begin::Input group-->
                                <h3 class="mb-10">Promo Code Basic Info</h3>

                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">Promo Code</label>
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" name="code" required/>
                                    </div> 
                                </div>

                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">Promo Code Discount</label>
                                    <div class="col-lg-8 fv-row">
                                        <input type="number" min="0" step="0.01" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" name="discount" required/>
                                    </div> 
                                </div>
